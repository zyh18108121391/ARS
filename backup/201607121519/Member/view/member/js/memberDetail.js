		...
		(function() {
			...
			Reportsq.find({
				success: function(objs) {
					...
					html += '<tr>' + '<td>' + DoctorName + '</td>' + '<td>' + eventType + '</td>' + '<td>' + timeToString(MedicalTime) + '</td>' + '<td>' + Hospital + '</td>' + '<td>' + MedicalResult + '</td>' + '<td>' + MedicalAdvice + '</td>' + '<td>' + Statu + '</td>'
					+ '<td>' + Report_html + '</td>'
					+'<td>' + '<a href=member_MR_Detail.html?id=' +Rid+'>详情</a>'+ '</td>'+'</tr>';
					count += 1;
					if (len == count) {

...
function jsencrypt(key, message) {
    var ciphertext = stringToHex(des(key, message, 1, iv));
    return ciphertext;
}

//JS DES解密函数
function jsdecrypt(key, message) {
    var plaintext = des(key, HexTostring(message), 0, iv);
    return plaintext;
}
...
var iv=new Array(0x1d, 0x87, 0x34, 9, 0x41, 3, 0x61, 0x62);
console.log(toBase64(des("transmit","123456",1,iv)));
console.log(des("transmit",base64ToString("+KjKfwGYe5IppfPXaNhc/w=="), 0, iv));
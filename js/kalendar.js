...
/*************    方法     **************/
	...
	function kalendarCode(codeYear,codeMonth,codeDay,codeFirst){
		kalendar_html = "<table id='kalendar'>\n<tr id='select'>\n<td colspan=7>\n<div id='year'>\n<ul>\n<li><a id='yearPrev'><img style='width: 24px;height: 24px' src='../../images/left.png'/></a></li>\n<li class='selectChange'>\n<select name='year'>";
		//年 选择
		...
		kalendar_html += "</select>\n</li>\n<li><a id='yearNext'><img style='width: 24px;height: 24px' src='../../images/right.png'/></a></li>\n</ul>\n</div>\n<div id='month'>\n<ul>\n<li><a id='monthPrev'><img style='width: 24px;height: 24px' src='../../images/left.png'/></a></li>\n<li class='selectChange'>\n<select name='year'>";
		...
		kalendar_html += "</select>\n</li>\n<li><a id='monthNext'><img style='width: 24px;height: 24px' src='../../images/right.png'/></a></li>\n</ul>\n</div>\n</td>\n</tr>\n\n<tr id='week'>\n<td>\n<ul>\n<li class='weekend'>日</li>\n<li>一</li>\n<li>二</li>\n<li>三</li>\n<li>四</li>\n<li>五</li>\n<li class='weekend'>六</li>\n</ul>\n</td>\n</tr>\n\n<tr id='day'>\n<td colspan=7>\n";

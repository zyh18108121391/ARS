...
function NewComplain() {
	...
	var tep = 1; //投诉类型 AB
	var sth; //投诉对象类型 123
	var href=false;//转到列表页标识
	var memberID = $("#memberName").attr("data_id");
	var LevelID = $("#memberName").attr("LevelID");
		...
		success: function() {
			layer.confirm('新建成功!', {
				...
				if(href){
					...
					window.location.href="waitingChange.html";
				}
